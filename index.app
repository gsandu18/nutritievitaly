...
<!-- Left Panel: Branding / Imagery (Hidden on small mobile) -->
<div class="hidden md:flex md:w-1/2 relative overflow-hidden bg-primary-container items-center justify-center">
<div class="absolute inset-0 bg-cover bg-center" data-alt="A bright, modern, and inspiring photograph of a clean, minimalist nutritionist workspace. A vibrant assortment of fresh green vegetables, colorful fruits, and a sleek modern tablet are arranged neatly on a pristine white marble countertop. The lighting is soft, high-key, and natural, coming from a large unseen window, creating a clinical yet approachable and inviting atmosphere. The color palette emphasizes fresh, vibrant greens, crisp whites, and subtle earthy tones, aligning perfectly with a premium health and wellness brand identity." style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuADE35DxH9mBHVTi2qVBC2eNS9g4OD8SPT5RGU6xYn-Ri2PkUELf5yEtEHmaevZWVaaL3j4XqVmJKfphA6ETPz_jIzKRuM2GvfRmqiGHNPyrb6Jl4CpgekZCL5z5zP6gcG1JxoznhKfpjkcEWnImn6bM-Rqp7LCQJGm9Nn4NsmG-3MZPoSq0bvo-j52HaESevjtgLB_9F4Xk4Jt5jznuiEAfYXt6sAXrGCdgq6TbNKn6Ta6XrbJWoL7cYNOEWJIbBC49DuJzdBZtxOE');"></div>
...
<input id="password" type="password" class="h-12 px-4 rounded-lg..." />
</div>
<!-- Submit Button -->
<button class="mt-sm h-12 w-full flex items-center justify-center gap-xs bg-primary text-on-primary font-label-md text-label-md rounded-lg hover:bg-surface-tint transition-all shadow-[0_2px_8px_0_rgba(0,0,0,0.04)] hover:shadow-[0_4px_12px_0_rgba(0,0,0,0.08)] active:scale-[0.98]" type="button">
